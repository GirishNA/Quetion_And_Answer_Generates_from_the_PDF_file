...
public static List<String> getPOSTaggerDistractors (String fileName, String queryString) {
	System.out.println("------------getPOSTaggerDistractors---->");
	...
	try {
		System.out.println("------->");
		urlString = "http://localhost:8030/hitMe?queryString="+URLEncoder.encode(queryString,"UTF-8")+"&&type=1&&fileName="+URLEncoder.encode(fileName,"UTF-8");
   ...
   public static List<String> getSSTTaggerDistractors (String fileName, String queryString) {
	      ...
	      String urlString="";
		try {
			urlString = "http://localhost:8030/hitMe?queryString="+URLEncoder.encode(queryString,"UTF-8")+"&&fileName="+URLEncoder.encode(fileName,"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
